...
class Sz58Spider(scrapy.Spider):
    name = 'sz58'
    allowed_domains = ['58.com']
    start_urls = ['http://sz.58.com/zufang/']
    # start_urls = ['http://wh.58.com/zufang/']
    with open('zf58.csv', 'a') as f:
    ...
    #     item['img_list'] = response.xpath('//div/ul[3]/li/img/@src').extract()
    #     print(item)
